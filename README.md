...
- Show workspaces and sessions in a mobile list view.
- Open one session as a full-screen conversation view.
- Return to the list with a top navigation control.
- Keep session creation and workspace context available.
- Avoid changing the desktop layout.
